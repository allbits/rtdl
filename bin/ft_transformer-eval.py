...
if __name__ == "__main__":
    ...
    zero.set_randomness(args['seed']) ## not 100% clear what this does
    ...
    x_cat=['129', 'as', '2', '1']
    y=predict(x_num,x_cat, num_new_values, max_values, num_nan_policy, cat_nan_policy, cat_policy, normalizer, encoder)

    print(y)

    ## functions
    def predict(x_num, x_cat, num_new_values, max_values, num_nan_policy, cat_nan_policy, cat_policy, normalizer, encoder):
        ...
        ## (4.2) transform categorical data (removed: 'most_frequent' and Imputer)
        ## (4.2.1) replace nan
        ...
        if cat_nan_mask.any():
            ...
            x_cat[cat_nan_indices] = cat_new_value
